...
export default class Deploy extends Command {
  ...
  async run() {
    ...
    cli.log('deploy : context = '+ JSON.stringify(ctx))
    ...
    console.log('EclipseCheInstallerFactory = ' + JSON.stringify(EclipseCheInstallerFactory.getInstaller().constructor.name))
