...
# Commands
<!-- commands -->
* [`chectl2 autocomplete [SHELL]`](#chectl2-autocomplete-shell)
* [`chectl2 cacert:export`](#chectl2-cacertexport)
* [`chectl2 dashboard:open`](#chectl2-dashboardopen)
* [`chectl2 help [COMMAND]`](#chectl2-help-command)
* [`chectl2 server:debug`](#chectl2-serverdebug)
* [`chectl2 server:delete`](#chectl2-serverdelete)
* [`chectl2 server:deploy`](#chectl2-serverdeploy)
* [`chectl2 server:logs`](#chectl2-serverlogs)
* [`chectl2 server:start`](#chectl2-serverstart)
* [`chectl2 server:status`](#chectl2-serverstatus)
* [`chectl2 server:stop`](#chectl2-serverstop)
* [`chectl2 server:update`](#chectl2-serverupdate)
* [`chectl2 update [CHANNEL]`](#chectl2-update-channel)

## `chectl2 autocomplete [SHELL]`
...
EXAMPLES
  $ chectl2 autocomplete
  $ chectl2 autocomplete bash
  $ chectl2 autocomplete zsh
  $ chectl2 autocomplete --refresh-cache
```
...
## `chectl2 help [COMMAND]`

Display help for chectl2.
...
## `chectl2 update [CHANNEL]`

update the chectl2 CLI
